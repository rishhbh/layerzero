  ...
  return (
    <div className="flex-1 flex items-center justify-center p-6 py-16 md:py-24 bg-background min-h-[calc(100vh-4rem)] relative overflow-hidden">
      ...
      <Card className="w-full max-w-md rounded-2xl border border-border bg-card/90 backdrop-blur-md relative z-10 shadow-xl">
        <CardHeader className="text-left pb-2 px-6 pt-6 md:px-8 md:pt-8 flex flex-col items-start">
          ...
          <CardTitle className="text-2xl font-heading font-medium tracking-tight text-foreground">Resend Verification</CardTitle>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <CardFooter className="flex flex-col space-y-3 px-6 pb-6 md:px-8 md:pb-8 pt-2 text-center">
            <Button type="submit" className="w-full rounded-full bg-primary text-primary-foreground hover:opacity-90 flex items-center justify-center gap-2 h-10 font-medium" disabled={isLoading}>
