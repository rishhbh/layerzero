    ...
    <div className="h-screen overflow-hidden flex bg-background text-foreground font-sans">
      ...
      <aside className="w-64 border-r border-border bg-card hidden md:flex flex-col">
        <div className="h-16 flex items-center px-6 border-b border-border">
          ...
          <span className="font-bold text-xl tracking-tight">LayerZero</span>
        </div>
        ...
        <div className="p-4 border-t border-border">
          <button
            onClick={logout}
            className="flex items-center space-x-3 px-3 py-2 w-full rounded-md text-muted-foreground hover:bg-muted hover:text-foreground transition-colors cursor-pointer"
          >
